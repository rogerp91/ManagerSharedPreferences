...
public class SP {
    ...
    /**
     * Initialize the ManagerPrefs helper class to keep a reference to the
    ...
    public static SharedPreferences getPreferences() {
        ...
        throw new RuntimeException("SP class not correctly instantiated please call Builder.setContext().build(); in the Application class onCreate.");
    }

    /**
     * @return Returns a map containing a list of pairs key/value representing
     * the setting_preferences.
    ...
    /**
     * Saves the double as a long raw bits inside the setting_preferences.
     *
     * @param key   The name of the preference to modify.
     * @param value The double value to be save in the setting_preferences.
     * @see Editor#putLong(String, long)
     */
    ...
    /**
     * @return the {@link Editor} for chaining. The changes have already been
     * committed/applied through the execution of this method.
     * @see Editor#clear()
     */
    @NonNull
    ...
    public final static class Builder {
         ...
         *
         * @param mode Operating mode. Use 0 or {@link Context#MODE_PRIVATE} for
        ...
        public void build() {
            ...
            SP.initPrefs(mContext, mKey, mMode);
        }
    }
}